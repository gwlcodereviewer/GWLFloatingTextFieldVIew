//
//  GWLFloatingLabelTextField.swift
//  GWLFloatingLabelTextField
//
//  Created by MAC-51 on 16/02/21.
//
...
@IBDesignable
open class GWLFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    /**
    ...
    /// A `ErrorMessagePlacement` value that determines wheerrorre the error message will be displayed.
    ...
    */
    override public init(frame: CGRect) {
        ...
        init_GWLFloatingLabelTextField()
    }
    ...
    fileprivate final func init_GWLFloatingLabelTextField() {
        borderStyle = .none
        createTitleLabel()
        createLineView()
        createErrorLabel()
    ...
    fileprivate func addEditingChangedObserver() {
        self.addTarget(self, action: #selector(GWLFloatingLabelTextField.editingChanged), for: .editingChanged)
    }
